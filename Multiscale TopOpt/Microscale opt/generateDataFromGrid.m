...
% for j=1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i=1:size(initDes,2)
        [Q,obji,microstruct]=unitCell8tz_3D(10,10,10,LHpoints(1,j),3,1.5,2,LHpoints(2,j),LHpoints(3,j),LHpoints(4,j),LHpoints(5,j),LHpoints(6,j),initDes(i),0.5); %changer après
