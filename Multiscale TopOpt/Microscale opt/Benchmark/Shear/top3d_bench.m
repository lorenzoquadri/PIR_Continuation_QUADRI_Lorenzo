...
% top3d_bench(45, 45, 9, 0.5, 3.0, 1.5)
% top3d_bench(18, 18, 9, 0.5, 3.0, 1.5)
% top3d_bench(45, 45, 9, 0.3, 3.0, 1.5)
function top3d_bench(nelx,nely,nelz,volfrac,penal,rmin)
...
%put forces and constraint nodes on the 6*6 grid
[il,jl,kl] = meshgrid(0:9:nelx,0:9:nely,nelz); 
loadnid = kl*(nelx+1)*(nely+1)+il*(nely+1)+(nely+1-jl); % Node IDs

% % put forces and constraint nodes on the 6*6 lines
...
%         xnew([1 7 8 9 10 16 17 18 19 25 26 27 28 34 35 36 37 44 45],1:nelx,1)=1;
%         xnew(1:nely,[1 7 8 9 10 16 17 18 19 25 26 27 28 34 35 36 37 44 45],1)=1;
        xPhys(:) = (H*xnew(:))./Hs;
