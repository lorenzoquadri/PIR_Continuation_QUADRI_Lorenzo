...
% top3d_bench(30, 10, 2, 0.5, 3.0, 1.2)
% top3d_bench(200, 200, 200, 0.5, 3.0, 1.2)
% top3d_bench(100, 100, 100, 0.5, 3.0, 1.2)
% top3d_bench(20, 20, 20, 0.5, 3.0, 1.2)
% top3d_bench(27, 27, 27, 0.5, 3.0, 1.5)
...
axis equal; axis tight; axis on; xlabel('x'); ylabel('z'); zlabel('y'); box on; view([30,30]); pause(1e-6);
end
% =========================================================================
